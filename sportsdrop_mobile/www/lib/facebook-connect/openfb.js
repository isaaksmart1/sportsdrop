...
var openFB = (function () {
  ...
  var loginURL = 'https://www.facebook.com/dialog/oauth',
    ...
    oauthRedirectURL = baseURL + '/oauthcallback.html', // lib/facebook-connect/
    ...
    logoutRedirectURL = baseURL + '/logoutcallback.html', // lib/facebook-connect/
  ...
  function login(callback, options) {
    ...
    function loginWindow_loadStartHandler(event) {
      ...
      if (url.indexOf("access_token=") > 0 || url.indexOf("error=") > 0) {
        ...
        var timeout = 100 - (new Date().getTime() - startTime);
        setTimeout(function () {
          loginWindow.close();
        }, timeout > 0 ? timeout : 0);
        oauthCallback(url);
   ...
   * @param url - The oautchRedirectURL called by Facebook with the access_token in the querystring at the end of the
   * OAuth workflow.
   */
