...
var iosPlatformsDir_dist_css = path.resolve(__dirname, '../../platforms/ios/www/dist/css');
var iosPlatformsDir_dist_js = path.resolve(__dirname, '../../platforms/ios/www/dist/js');
...
var iosPlatformsDir_www_js = path.resolve(__dirname, '../../platforms/ios/www/js');
...
var androidPlatformsDir_dist_css = path.resolve(__dirname, '../../platforms/android/assets/www/dist/css');
var androidPlatformsDir_dist_js = path.resolve(__dirname, '../../platforms/android/assets/www/dist/js');
var androidPlatformsDir_dist_index = path.resolve(__dirname, '../../platforms/android/assets/www/dist/index.html');
var androidPlatformsDir_www_css = path.resolve(__dirname, '../../platforms/android/assets/www/css');
var androidPlatformsDir_www_js = path.resolve(__dirname, '../../platforms/android/assets/www/js');
